    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
            ...
            ท่านได้รับเชิญให้เข้าร่วมวิจัยนี้เพราะท่านอยู่ในช่วงอายุที่กำหนดคือ เป็นบุคคลที่มีอายุ 18-60 ปี หรือเป็น ผู้สูงอายุที่มีอายุ 60-80 ปี ที่อยู่ภายใต้การดูแลของโรงพยาบาลจุฬาลงกรณ์ สภากาชาดไทย ทั้งผู้ที่มีภาวะ MCI และไม่มีภาวะ MCI ที่ผ่านการคัดกรองเรียบร้อยแล้วด้วยแบบทดสอบ MoCA จากทางโรงพยาบาล มีสัญชาติไทย อ่านและพูดภาษาไทย ไม่มีภาวะตาบอดสี และไม่มีความผิดปกติทางสมอง  โดยจะมีผู้เข้าร่วมการทดลองเข้าร่วมวิจัยอย่างน้อย 90 คน
