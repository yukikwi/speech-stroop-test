    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
            ...
            ท่านได้รับเชิญให้เข้าร่วมวิจัยนี้เพราะท่านอยู่ในช่วงอายุที่กำหนดคือ เป็นบุคคลที่มีอายุ 18-60 ปี หรือเป็น ผู้สูงอายุที่มีอายุ 60-80 ปี ที่อยู่ภายใต้การดูแลของโรงพยาบาลจุฬาลงกรณ์ สภากาชาดไทย ทั้งผู้ที่มีภาวะ MCI และไม่มีภาวะ MCI ที่ผ่านการคัดกรองเรียบร้อยแล้วด้วยแบบทดสอบ MoCA จากทางโรงพยาบาล มีสัญชาติไทย อ่านและพูดภาษาไทยในสำเนียงภาคกลาง ไม่มีภาวะตาบอดสี และไม่มีความผิดปกติทางสมอง โดยจะมีผู้เข้าร่วมการทดลองเข้าร่วมวิจัยอย่างน้อย 90 คน
            ...
            1. ผู้เข้าร่วมการทดลองจะต้อง
            2. ผู้เข้าร่วมการทดลองจะต้อง
            3. ผู้เข้าร่วมการทดลองจะต้อง
            4. ผู้เข้าร่วมการทดลองจะต้องทำการกรอกรหัสการทดลองของตนเองที่ได้รับมา
            5. ผู้เข้าร่วมการทดลองจะต้องทำแบบทดสอบการอ่าน
            6. ผู้เข้าร่วมการทดลองจะต้องทำแบบทดสอบการจำแนกสี
            7. ผู้เข้าร่วมการทดลองจะต้องทำแบบทดสอบ Speech Stroop โดยการทดสอบจะจะถูกแบ่งย่อยเป็น 3 รอบ ในหนึ่งรอบมี 3 ส่วน ส่วนละ 60 ข้อ ซึ่งหลังจบแต่ละส่วนจะมีการเว้นช่วงในการพัก โดยสามารถพักได้เป็นระยะเวลาเท่าไหร่ก็ได้ตามที่ต้องการ
            8. ในการทดลองจะใช้เวลาประมาณโดยประมาณ 2 ชั่วโมง ขึ้นอยู่กับระยะเวลาการพักของผู้เข้าร่วมการทดลอง
